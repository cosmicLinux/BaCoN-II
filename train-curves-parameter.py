...
# training data
DIR='data/data_ben/ee2_obstd_0p016/nu_wb/training_sets_5' # ee2 valid
#DIR='data/data_ben/hmcode_updated/hmcode2020/train_data_hmcode-new_5' # HMcode2020 Updated
# older data 
#DIR='data/train_data_full' # old Halofit bacon github data
#DIR='data/data_ben/EE2_B1' # EE2 like Bacon 1, no mu/bary, made in Aug 2023
#DIR='data/data_ben/training_data_full_noDS' # wrong (?) data HMcode2020 (massive n + baryons) - without split, 18475 files
...
train_fname = 'NB_EE2_train18k'
test_fname = '5'
planck_fname = 'hmcode2020'
fname_extra = '2500Curves-sigmaCurves020'
...
# sys error curves - sigma of curve-amplitude Gaussian
sigma_curves='0.20'
...
patience='70' # terminate training after 'patience' epochs if no decrease in loss function
...
if add_noise=='True':
   ...
   if add_sys=='True':
      fname = fname + '_wSys' 
      fname = fname + '_sigmaCurves' + sigma_curves
   else:
      fname = fname + '_noSys'
else:
